                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        <div class="mb-3">
                            ...
                            <input type="name" class="form-control" name="name" placeholder="Masukkan nama anda" required value="<?php echo ($id) ? $rowEdit['name'] : '' ?>">

                        </div>
                        <div class="mb-3">
                            <label for="">Email</label>
                            <input type="email" class="form-control" name="email" placeholder="Masukkan email anda" required value="<?php echo ($id) ? $rowEdit['email'] : '' ?>">

                        </div>
                        <div class="mb-3">
                            <label for="">password</label>
                            <input type="password" class="form-control" name="password" placeholder="Masukkan password" <?php echo (!$id) ? 'required' : '' ?>>
