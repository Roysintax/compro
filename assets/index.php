...
//jika email dan pasword terisi maka
//tampilkan atau pilih semua data dari table users dimana emailonya adalah
                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_GET['error'])) {
                                        if ($_GET['error'] == 'password') {
                                            ...
                                            echo '<div class="alert alert-danger" role="alert">Email is incorrect!</div>';
                                        }
                                    }
                                    ?>
